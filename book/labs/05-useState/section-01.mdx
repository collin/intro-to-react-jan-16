...
in the folder: `labs/05-useState/your-solution/counter`.

During this lab, you will be making edits to the code in that folder.

The starting point for this lab has some buttons to add and subtract from the count.
...
Try-out this inline example of a component that uses `useState` to track a name for a name tag.
<LiveCode
  noWrap
  noInline={false}
